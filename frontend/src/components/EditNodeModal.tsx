...
export default function EditNodeModal({
    ...
    }, [isCreate, node.id, node.name]); // eslint-disable-line react-hooks/exhaustive-deps
        ...
        >
            ...
            >
                ...
                >
                    <button
                        onClick={() =>
                            setForm((f) => ({ ...f, important: !f.important }))
                        }
                        style={{
                            width: 44,
                            height: 24,
