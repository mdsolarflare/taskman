            ...
            >
                            ...
                            >
                                <span
                                    style={{
                                        ...
                                        border: "1px solid var(--border-color)",
                                        background:
                                            "linear-gradient(135deg, #888, #ccc, #888)",
                                        flexShrink: 0,
                                    }}
                                />
                                <span>Custom</span>
                ...
                {showEditor && (
                    <>
                        ...
                        >
                            Adjust the 12 color roles below. Changes preview
                            live. Press <strong>Save</strong> to persist as a
                            custom theme.
                        </p>
