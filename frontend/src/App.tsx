    ...
    return (
        ...
        >
            ...
            >
                {state.error ? (
                    ...
                    >
                        ...
                        >
                            A local-first task graph engine. Visualize your
                            tasks and their dependencies as an interactive
                            graph.
                        </p>
                        <div
                            style={{
            ...
            {showHelp && (
                ...
                >
                    ...
                    >
                        ...
                        >
                            A local-first task graph engine built with
                            Rust/WASM. Data is parsed by the Rust layer and
                            rendered as an interactive graph in your browser.
                        </p>
                        <div
                            style={{
                                display: "flex",
            ...
            {deletingNodeId !== null && state.graph && (
                <DeleteNodeDialog
                    nodeName={
                        state.graph.nodes.find((n) => n.id === deletingNodeId)
                            ?.name ?? ""
                    }
                    hasChildren={
                        (state.graph.nodes.find((n) => n.id === deletingNodeId)
